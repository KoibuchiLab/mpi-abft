...
int main(int argc, char *argv[]) {
    ...
    MPI_Bcast(&matrix_properties[0], 4, MPI_UNSIGNED, 0, MPI_COMM_WORLD);
    ...
    OPTWEB_MPI_Bcast(m_a, size_a , MPI_UNSIGNED, 0, MPI_COMM_WORLD);
    OPTWEB_MPI_Bcast(m_b, size_b , MPI_UNSIGNED, 0, MPI_COMM_WORLD);
    ...
    /* collect the results */
    MPI_Gather(result_matrix, number_of_rows, MPI_UNSIGNED,
           final_matrix, number_of_rows,  MPI_UNSIGNED, 0, MPI_COMM_WORLD);
